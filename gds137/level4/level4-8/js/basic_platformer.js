...
function animate()
{
	...
	while(platform1.hitTestPoint(player.top()) && player.vy <=0 && !keyGot)
	{
		player.y++;
		player.vy = 0;
	}
	while(platform1.hitTestPoint(player.bottom()) && player.vy >=0 && !keyGot)
	{
		player.y--;
		player.vy = 0;
		player.canJump = true;
	}
	while(platform1.hitTestPoint(player.left()) && player.vx <=0 && !keyGot)
	{
		player.x++;
		player.vx = 0;
	}
	while(platform1.hitTestPoint(player.right()) && player.vx >=0 && !keyGot)
	{
		player.x--;
		player.vx = 0;
	}
